...
<!-- Botão para ver a receita só aparece no hover e só se preço = 0 -->
  ...
  <div class="best-features">
    <div class="container">
      <div class="row">
        <div class="col-md-12"><div class="section-heading"><h2>Sobre o Sabores da CPLP</h2></div></div>
        <div class="col-md-6">
          <div class="left-content">
            <h4>À procura de receitas autênticas?</h4>
            <p>Reunimos receitas tradicionais dos países da CPLP para que possa explorar e comprar facilmente. Inspire-se, cozinhe e saboreie.</p>
            <ul class="featured-list">
              <li><a href="#">Receitas testadas e validadas</a></li>
              <li><a href="#">Sabores de todos os países lusófonos</a></li>
              <li><a href="#">Compra simples e rápida</a></li>
              <li><a href="#">Novidades todas as semanas</a></li>
              <li><a href="#">Dicas e variações de chefs</a></li>
            </ul>
            <a href="about.php" class="filled-button">Saber mais</a>
          </div>
        </div>
        <div class="col-md-6"><div class="right-image"><img src="assets/images/feature-image.jpg" alt="Sabores da CPLP"></div></div>
      </div>
    </div>
  </div>
  ...
  <footer>
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          <div class="inner-content">
            <p>Copyright &copy; <?= date('Y') ?> Sabores da CPLP.
              Template base: <a rel="nofollow noopener" href="https://templatemo.com" target="_blank">TemplateMo</a></p>
          </div>
        </div>
      </div>
    </div>
...
<script>
  ...
  jQuery(function($){
    ...
    $banner.owlCarousel({
      ...
      loop: true,
      autoplay: true,
      autoplayTimeout: 2000,      // 4s entre slides
